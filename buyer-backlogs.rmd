...
subplot(backlog_plain_timemachine_inv_plot, backlog_plain_timemachine_ninv_plot, backlog_plain_timemachine_se_plot, nrows = 3) %>% 
  config(displayModeBar = FALSE)
```
...
subplot(backlog_timemachine_90dayplus_sum_inv_plot, 
        ...
        backlog_timemachine_90dayplus_sum_se_plot, nrows = 3) %>% 
  config(displayModeBar = FALSE)
