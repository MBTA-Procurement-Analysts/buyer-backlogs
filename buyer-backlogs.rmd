...
### PP's Worklist Details (`r approval_30days_count`)

*Omitted `r (approval_total_count - approval_30days_count)` entries less than $50,000.*


```{r echo=FALSE}
kable(approval_30days_detail_table) %>% 
  kable_styling() %>% 
  add_header_above(c("Worklist Data" = 4,"Req Details" = 3))
```
<P style="page-break-before: always">
